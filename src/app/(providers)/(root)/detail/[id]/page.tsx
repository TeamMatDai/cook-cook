...
const DetailPage: React.FC = () => {
  ...
  return (
    <>
      <article className="pb-[420px] bg-red-600 bg-[linear-gradient(to_bottom,_rgba(255,_255,_255,_0)_50%,_#fff)] h-[500px]">
        <header className="h-[80px] bg-black flex flex-row justify-between items-center px-[2px]">
          <IconBackButton />
          <IconSearch />
        </header>
      </article>
