...
const Loader = () => {
  return (
    <div
      className={`fixed top-0 bottom-0 left-1/2 transform -translate-x-1/2 bg-white z-50 ${LAYOUT.CONTAINER_MAX_WIDTH} w-full ${LAYOUT.BOTTOM_NAV_HEIGHT} border-t border-[#F1F1F1] flex items-center justify-center h-dvh`}
    >
